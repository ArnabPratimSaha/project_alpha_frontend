...
function Dashboard() {
    ...
    {
        const leftDiv=document.getElementsByClassName('dashboard-left-div')[0];
        const icon=document.getElementsByClassName('dashboard-toggle-button__icon')[0]
        if(leftDiv.style.width==='100%'){
            leftDiv.style.width='60%';
            icon.style.transform='translateY(-50%) rotateZ(-90deg)'
        }
        else if(leftDiv.style.width==='60%'){
                ...
                <div className='dashboard-content-div'>
                    <div className='dashboard-left-div' style={{backgroundColor:mode===MODETYPE.DARK?'#666':'#f2f2f2'}}>
                        <div className='dashboard-button-div'>
                            ...
                            <button type='button' name='message' className="dashboard-button-div__message" onClick={handleTabButtonClick} style={{backgroundColor:'#66dbff'}}>message</button>
                            <button type='button' name='members' className="dashboard-button-div__members" onClick={handleTabButtonClick} style={{backgroundColor:'#66dbff'}}>members</button>
                            <button type='button' name='rolesandchannels' className="dashboard-button-div__rolesandchannels" onClick={handleTabButtonClick} style={{backgroundColor:'#66dbff'}}>roles & channels</button>
                        </div>
                        <div className='dashboard-toggle-button'>
                            <MdArrowDropDownCircle className="dashboard-toggle-button__icon" onClick={handleTogglerClick}/>
                        </div>
                    ...
                    <div className='dashboard-right-div' style={{backgroundColor:mode===MODETYPE.DARK?'#777':'#cacaca'}}>
